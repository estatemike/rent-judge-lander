...
export default () => (
  <Layout>
    <section className="pt-5 container mx-auto px-8">
      <h1>Terms and Conditions</h1>
      <p>Last updated: October 01, 2020</p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to RealEquityApps, California.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Service</strong> refers to the Website and Mobile Application.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to RentJudge, accessible from{' '}
            <a href="https://www.rentjudge.com/" rel="external nofollow noopener" target="_blank">
              https://www.rentjudge.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: realequityapps@gmail.com</li>
      </ul>
    </section>
  </Layout>
);
